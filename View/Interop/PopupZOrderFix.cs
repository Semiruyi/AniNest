...
namespace LocalPlayer.View.Interop;

/// <summary>
/// 修复 WPF Popup 浮在所有窗口顶层的问题。
/// 关键：SetWindowPos(HWND_NOTOPMOST) 用 GetWindowRect 取实际坐标，
/// 不加 SWP_NOMOVE|SWP_NOSIZE，系统才会处理 z-order 变更。
/// SetWindowLongPtr(GWLP_HWNDPARENT) 设 Owner 确保 Popup 不掉到主窗口背后。
/// </summary>
