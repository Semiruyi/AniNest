...
dotnet run --project .\src\LocalPlayer\AniNest.csproj
```

发布：

```powershell
dotnet publish .\src\LocalPlayer\AniNest.csproj -c Release -r win-x64 --self-contained true -o .\artifacts\publish
```
